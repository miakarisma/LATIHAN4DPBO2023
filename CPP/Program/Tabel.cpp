...
// Kelas Tabel merupakan kelas untuk menampilkan tabel data list dalam bentuk tabel
class Tabel
{
    ...
    public:
        ...
        // Method untuk menampilkan list mahasiswa dalam bentuk tabel
        void buatBarisMahasiswa(int baris, int kolom, string data[][7])
        {
            int i = 0, j = 0;
            int max[kolom];
            for (i = 0; i < kolom; i++) {
        ...
        // Method untuk menampilkan list mata kuliah dalam bentuk tabel
        void buatBarisMataKuliah(int baris, int kolom, string data[][3])
        {
            int i = 0, j = 0;
            int max[kolom];
            for (i = 0; i < kolom; i++) {
        ...
        // Method untuk menampilkan list dosen dalam bentuk tabel
        void buatBarisDosen(int baris, int kolom, string data[][9])
        {
            int i = 0, j = 0;
            int max[kolom];
            for (i = 0; i < kolom; i++) {
